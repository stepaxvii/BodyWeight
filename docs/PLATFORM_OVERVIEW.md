...
Базовый XP рассчитывается как:
```
base_xp × количество_повторений × модификатор_сложности
```
...
|-------|---------|-----------|
| Серия | Текущий streak | До +50% (макс на 30+ днях) |
| Первая тренировка дня | Первая за день | +20% |
| Объём | Много повторений | Прогрессивный с убыванием |
